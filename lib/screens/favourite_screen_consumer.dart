...
class FavouriteScreenConsumer extends StatelessWidget {
  final List<dynamic> allProducts;
  const FavouriteScreenConsumer({super.key, required this.allProducts});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Consumer<FavouriteViewModel>(
        builder: (context, fvm, chilld) {
          final favProducts = allProducts
              .where((product) => fvm.isFavourite(product['id']))
              .toList();
